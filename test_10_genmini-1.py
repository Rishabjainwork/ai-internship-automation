...
def run_automation():
    with sync_playwright() as p:
        ...
        for idx, internship in enumerate(internships[28:100], start=28):
            ...
            page.fill('#input_36_5', '7015691261')
            page.fill('#input_36_45', 'INDIAN')
            page.fill('#input_36_11', '7015691261')
            page.fill('#input_36_8', 'rishabjain1006@gmail.com')
            page.fill('#input_36_3', 'Tohana')
            page.fill('#input_36_12', 'B.tech')
            page.fill('#input_36_13', 'Computer Science')
            page.fill('#input_36_14', 'VIT Bhopal')
            page.fill('#input_36_21', '2025')
            page.check('#choice_36_17_1')
            page.fill('#input_36_20', '9')
            page.fill('#input_36_15_3', 'kotrikalan village')
            page.fill('#input_36_15_4', 'Madhya pradesh')
            page.fill('#input_36_7', 'rishab.25bce10989@vitbhopal.ac.in')
            page.fill('#input_36_7_2', 'rishab.25bce10989@vitbhopal.ac.in')
            page.select_option('#input_36_15_6', value='India')
    

            page.fill('#input_36_10', '09-12-2006') 
